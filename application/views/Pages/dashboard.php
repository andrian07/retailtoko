      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between">
            ...
            <h4 class="text-info fw-bold" style="margin-top:-5px;"><?php echo number_format($data['get_transaction_today'][0]['total_today'] ?? 0); ?></h4>
          </div>
          <div class="d-flex justify-content-between mt-2">
            <p class="text-muted mb-0">Jumlah Transaksi</p>
            <p class="text-muted mb-0"><?php echo number_format($data['get_transaction_today'][0]['total_transaction'] ?? 0); ?> kali</p>
          </div>
          <div class="d-flex justify-content-between mt-2">
            <p class="text-muted mb-0">Jumlah Barang</p>
            <p class="text-muted mb-0"><?php echo number_format($data['get_transaction_today_item'][0]['total_item'] ?? 0); ?>  Item</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between">
            ...
            <h4 class="text-success fw-bold" style="margin-top:-5px;"><?php echo number_format($data['get_transaction_month'][0]['total_month'] ?? 0); ?></h4>
          </div>
          <div class="d-flex justify-content-between mt-2">
            <p class="text-muted mb-0">Jumlah Transaksi</p>
            <p class="text-muted mb-0"><?php echo number_format($data['get_transaction_month'][0]['total_transaction'] ?? 0); ?> kali</p>
          </div>
          <div class="d-flex justify-content-between mt-2">
            <p class="text-muted mb-0">Jumlah Barang</p>
            <p class="text-muted mb-0"><?php echo number_format($data['get_transaction_month_item'][0]['total_item'] ?? 0); ?>  Item</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between">
            ...
            <h4 class="text-danger fw-bold" style="margin-top:-5px;"><?php echo number_format($data['get_total_asset'][0]['total_omzet'] ?? 0); ?> </h4>
          </div>
          <div class="d-flex justify-content-between mt-2">
            <p class="text-muted mb-0">Jumlah Item</p>
            <p class="text-muted mb-0"><?php echo number_format($data['get_total_asset_item'][0]['total_item'] ?? 0); ?> Item</p>
          </div>
        </div>
      </div>
    </div>
