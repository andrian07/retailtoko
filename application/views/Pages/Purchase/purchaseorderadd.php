      ...
      <div class="col-md-12 mb-2">
        <div class="po-page-title-bar">
          ...
          <div>
            ...
            <small>Form input PO pembelian baru ke supplier</small>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-4 po-field-group">
                ...
                <input id="purchase_order_due_date" name="purchase_order_due_date" type="date" class="form-control" value="">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-2 po-field-group">
                ...
                <select class="form-control" id="po_tax" name="po_tax" readonly>
          ...
          <div class="card-body">
            ...
            <div class="row mt-4">
              <div class="col-lg-6">
                ...
                <textarea id="purchase_order_remark" name="purchase_order_remark" class="form-control" placeholder="Tuliskan catatan PO di sini..." maxlength="500" rows="9" style="border-radius:8px; resize:none;"></textarea>
              </div>
