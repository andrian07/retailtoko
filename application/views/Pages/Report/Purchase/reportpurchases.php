...
<div class="container">
  <div class="page-inner">
    ...
    <div class="report-page-header">
      ...
      <div>
        ...
        <p>Monitoring data transaksi pembelian</p>
      </div>
    </div>
        ...
        <div class="card preview-card">
          <div class="card-header">
            <span class="preview-title">
              <i class="fas fa-eye"></i> Preview Laporan Pembelian
            </span>
          ...
          <div class="card-body">
            ...
            <iframe id="preview"
              src="<?php echo base_url(); ?>Reportpurchase/reportpurchasespdf"
  ...
  <script type="text/javascript">
    ...
    $('#btnsearch').click(function(e) {
      e.preventDefault();
      showLoading();
      let url = buildUrl('<?php echo base_url(); ?>Reportpurchase/reportpurchasespdf?');
    ...
    $('#btndownloadexcell').click(function(e) {
      e.preventDefault();
      let url = buildUrl('<?php echo base_url(); ?>Reportpurchase/reportpurchases_excell?');
