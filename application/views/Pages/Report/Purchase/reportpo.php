...
<div class="container">
  <div class="page-inner">
    ...
    <div class="report-page-header">
      ...
      <div>
        ...
        <p>Monitoring data pembelian berdasarkan Purchase Order</p>
      </div>
    </div>
              ...
              <div class="row align-items-end g-3">
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group mb-0">
                    ...
                    <select class="form-control js-example-basic-single" id="status_pembelian" name="status_pembelian">
        ...
        <div class="card preview-card">
          <div class="card-header">
            <span class="preview-title">
              <i class="fas fa-eye"></i> Preview Laporan Purchase Order
            </span>
          ...
          <div class="card-body">
            ...
            <iframe id="preview"
              src="<?php echo base_url(); ?>Reportpurchase/reportpopdf"
  ...
  <script type="text/javascript">
    function buildUrl(base) {
      ...
      let status          = $('#status_pembelian').val();
      return base
    ...
    $('#btnsearch').click(function(e) {
      e.preventDefault();
      showLoading();
      let url = buildUrl('<?php echo base_url(); ?>Reportpurchase/reportpopdf?');
    ...
    $('#btndownloadexcell').click(function(e) {
      e.preventDefault();
      let url = buildUrl('<?php echo base_url(); ?>Reportpurchase/reportpo_excell?');
