...
<div class="container">
  <div class="page-inner">
    ...
    <div class="report-page-header">
      ...
      <div>
        <h3>Laporan Hutang Jatuh Tempo</h3>
        <p>Monitoring tagihan hutang berdasarkan tanggal jatuh tempo</p>
      </div>
    </div>
              ...
              <div class="row align-items-end g-3">
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group mb-0">
                    <label><i class="far fa-calendar-alt me-1"></i>Jatuh Tempo Dari</label>
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group mb-0">
                    <label><i class="far fa-calendar-alt me-1"></i>Jatuh Tempo Sampai</label>
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group mb-0">
                    <label><i class="fas fa-truck me-1"></i>Supplier</label>
                    <select class="form-control js-example-basic-single" id="supplier_report" name="supplier_report">
        ...
        <div class="card preview-card">
          <div class="card-header">
            <span class="preview-title">
              <i class="fas fa-eye"></i> Preview Laporan Hutang Jatuh Tempo
            </span>
          ...
          <div class="card-body">
            ...
            <iframe id="preview"
              src="<?php echo base_url(); ?>Reportpayment/reportdebtduedatepdf"
  ...
  <script type="text/javascript">
    ...
    $('#btnsearch').click(function(e) {
      e.preventDefault();
      showLoading();
      let url = buildUrl('<?php echo base_url(); ?>Reportpayment/reportdebtduedatepdf?');
    ...
    $('#btndownloadexcell').click(function(e) {
      e.preventDefault();
      let url = buildUrl('<?php echo base_url(); ?>Reportpayment/reportdebtduedate_excell?');
