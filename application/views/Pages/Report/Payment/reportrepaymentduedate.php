...
<div class="container">
  <div class="page-inner">
    ...
    <div class="report-page-header">
      ...
      <div>
        <h3>Laporan Piutang Jatuh Tempo</h3>
        <p>Monitoring tagihan piutang berdasarkan tanggal jatuh tempo</p>
      </div>
    </div>
        ...
        <div class="card preview-card">
          <div class="card-header">
            <span class="preview-title">
              <i class="fas fa-eye"></i> Preview Laporan Piutang Jatuh Tempo
            </span>
          ...
          <div class="card-body">
            ...
            <iframe id="preview"
              src="<?php echo base_url(); ?>Reportpayment/reportrepaymentduedatepdf"
  ...
  <script type="text/javascript">
    ...
    $('#btnsearch').click(function(e) {
      e.preventDefault();
      showLoading();
      let url = buildUrl('<?php echo base_url(); ?>Reportpayment/reportrepaymentduedatepdf?');
    ...
    $('#btndownloadexcell').click(function(e) {
      e.preventDefault();
      let url = buildUrl('<?php echo base_url(); ?>Reportpayment/reportrepaymentduedate_excell?');
