...
<div class="container">
  <div class="page-inner">
    ...
    <div class="row">
      <h3 class="fw-bold mb-3">Laporan Pembayaran Piutang </h3>
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <div class="card-body">
        ...
        <div class="card">
          <div class="card-body">
            <iframe id="preview" src="<?php echo base_url(); ?>Reportpayment/reportpiutangpdf" width="100%" height="1000px"></iframe>
          </div>
        </div>
