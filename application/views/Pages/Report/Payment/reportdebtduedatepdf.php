...
<body>
    <div class="container">
        <h2 class="headline">Laporan Hutang Jatuh Tempo</h2>
            ...
            <tbody>
                <?php foreach($data as $row){ ?>
                    <tr>
                        ...
                        <td>Rp. <?php echo number_format($row['hd_purchase_dp']); ?></td>
                        <td>Rp. <?php echo number_format($row['hd_purchase_remaining_debt']); ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
