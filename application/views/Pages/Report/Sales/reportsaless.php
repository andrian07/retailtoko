...
<div class="container">
  <div class="page-inner">
    ...
    <div class="report-page-header">
      ...
      <div>
        ...
        <p>Monitoring data transaksi penjualan</p>
      </div>
    </div>
        ...
        <div class="card preview-card">
          <div class="card-header">
            <span class="preview-title">
              <i class="fas fa-eye"></i> Preview Laporan Penjualan
            </span>
          ...
          <div class="card-body">
            ...
            <iframe id="preview"
              src="<?php echo base_url(); ?>Reportsales/reportsalesspdf"
  ...
  <script type="text/javascript">
    ...
    $('#btnsearch').click(function(e) {
      e.preventDefault();
      showLoading();
      let url = buildUrl('<?php echo base_url(); ?>Reportsales/reportsalesspdf?');
    ...
    $('#btndownloadexcell').click(function(e) {
      e.preventDefault();
      let url = buildUrl('<?php echo base_url(); ?>Reportsales/reportsaless_excell?');
