...
<div class="container">
  <div class="page-inner">
    ...
    <div class="report-page-header">
      ...
      <div>
        ...
        <p>Monitoring data retur barang penjualan</p>
      </div>
    </div>
        ...
        <div class="card preview-card">
          <div class="card-header">
            <span class="preview-title">
              <i class="fas fa-eye"></i> Preview Laporan Retur Penjualan
            </span>
          ...
          <div class="card-body">
            ...
            <iframe id="preview"
              src="<?php echo base_url(); ?>Reportsales/reportretursalespdf"
  ...
  <script type="text/javascript">
    ...
    $('#btnsearch').click(function(e) {
      e.preventDefault();
      showLoading();
      let url = buildUrl('<?php echo base_url(); ?>Reportsales/reportretursalespdf?');
    ...
    $('#btndownloadexcell').click(function(e) {
      e.preventDefault();
      let url = buildUrl('<?php echo base_url(); ?>Reportsales/reportretursales_excell?');
