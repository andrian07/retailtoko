...
<div class="container">
  <div class="page-inner">
    ...
    <div class="row">
      <h3 class="fw-bold mb-3">Laporan Hutang Jatuh Tempo </h3>
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <div class="card-body">
        ...
        <div class="card">
          <div class="card-body">
            <iframe id="preview" src="<?php echo base_url(); ?>Reportpayment/reportdebtduedatepdf" width="100%" height="1000px"></iframe>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    $('#btnsearch').click(function(e) {
      ...
      let url = '<?php echo base_url(); ?>Reportpayment/reportdebtduedatepdf?';
    ...
    $('#btndownloadexcell').click(function(e) {
      ...
      let end_date         = $('#end_date').val();
      let supplier_report  = $('#supplier_report').val();
      let url = '<?php echo base_url(); ?>Reportpayment/reportdebtduedate_excell?';
      url += '&start_date=' + start_date;
      url += '&end_date=' + end_date;
      url += '&supplier_report=' + supplier_report;
