...
<div class="container">
  <div class="page-inner">
    ...
    <div class="row">
      <h3 class="fw-bold mb-3">Laporan Pembayaran Hutang </h3>
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-3">
                    ...
                    <div class="form-group">
                      <label>Tanggal Pembayaran Dari:</label>
                  ...
                  <div class="col-sm-3">
                    <!-- text input -->
                    <div class="form-group">
                      <label>Tanggal Pembayaran Sampai:</label>
        ...
        <div class="card">
          <div class="card-body">
            <iframe id="preview" src="<?php echo base_url(); ?>Reportpayment/reportrepaymentpdf" width="100%" height="1000px"></iframe>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    $('#btnsearch').click(function(e) {
      ...
      let url = '<?php echo base_url(); ?>Reportpayment/reportrepaymentpdf?';
    ...
    $('#btndownloadexcell').click(function(e) {
      ...
      let end_date         = $('#end_date').val();
      let supplier_report  = $('#supplier_report').val();
      let url = '<?php echo base_url(); ?>Reportpayment/reportrepayment_excell?';
      url += '&start_date=' + start_date;
      url += '&end_date=' + end_date;
      url += '&supplier_report=' + supplier_report;
