...
<div class="container">
  <div class="page-inner">
    ...
    <div class="row">
      <h3 class="fw-bold mb-3">Laporan Sales Order </h3>
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <div class="card-body">
        ...
        <div class="card">
          <div class="card-body">
            <iframe id="preview" src="<?php echo base_url(); ?>Reportsales/reportsalesorderpdf" width="100%" height="1000px"></iframe>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    $('#btnsearch').click(function(e) {
      ...
      let url = '<?php echo base_url(); ?>Reportsales/reportsalesorderpdf?';
    ...
    $('#btndownloadexcell').click(function(e) {
      ...
      let salesman_report  = $('#salesman_report').val();
      let warehouse_report = $('#warehouse_report').val();
      let url = '<?php echo base_url(); ?>Reportsales/reportsalesorder_excell?';
      url += '&start_date=' + start_date;
      url += '&end_date=' + end_date;
      url += '&customer_report=' + customer_report;
      url += '&salesman_report=' + salesman_report;
