...
class masterdata_model extends CI_Model {
    ...
    public function product_list($search, $length, $start, $supplier_filter, $category_filter, $brand_filter,$product_status_filter)
    {
        $this->db->select('*');
    ...
    public function product_list_count($search, $supplier_filter, $category_filter, $brand_filter, $product_status_filter)
    {
        $this->db->select('count(*) as total_row');
         $this->db->from('ms_product');
        $this->db->join('ms_brand', 'ms_product.product_brand = ms_brand.brand_id');
